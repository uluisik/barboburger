 ...
 <?php
        if ($_POST) {  
           ...
           if ($masa_adi <> "" && $isim_soyisim <> "" ) {
                                ...
                                $sql = "INSERT INTO garson_cagir SET masa_adi=:masa_adi, isim_soyisim=:isim_soyisim, telefon=:telefon;";
...
alert("Talebiniz Başarı İle Alınmıştır. ")
     ...
     <div id="pages_maincontent">
      ...
      <h2 class="page_title"><center><?php echo $dil["garson-cagir"];?></center></h2>
     ...
     <div class="page_single layout_fullwidth_padding">	  
            ...
            <input type="number" name="telefon" id="telefon" value="" class="form_input required email" / >
        ...
        <?}?> 
            ...
            <label id="loader" style="display:none;"><img src="images/loader.gif" alt="Loading..." id="LoadingGraphic" /></label>
              ...
              <blockquote>
            <center><?php echo $dil["garson-aciklama"];?></center>
      </blockquote> 
