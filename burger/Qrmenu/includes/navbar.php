<body id="mobile_wrap">
				...
				<div class="swiper-slide">
					...
					<nav class="main_nav_icons_inline_2">
						...
						<!-- 	<?
							...
							$user = $_SESSION["user"];
							if(!$user->loggedIn){?>
								<li><a href="#" data-popup=".popup-login" class="open-popup close-panel"><img src="images/icons/white/lock.png" alt="" title="" /><span>Giriş</span></a></li>
								<li><a href="#" data-popup=".popup-signup" class="open-popup close-panel"><img src="images/icons/white/form.png" alt="" title="" /><span>Kayıt Ol</span></a></li>
							<? }else{ ?>
								<li><a href="uye-bilgileri.php"  ><img src="images/icons/white/form.png" alt="" title="" /><span>Profilim</span></a></li>
								<li><a href="cikis.php"  ><img src="images/icons/white/form.png" alt="" title="" /><span>Çıkış</span></a></li>
								<?}?> -->
					...
					<ul>
						...
						<form method="post" action="arama.php" id="searchform" class="search-form" _lpchecked="1">
							<div class="contactform">
								...
								<input type="text" name="arama" id="arama" placeholder="örnk: Et Sote" value="" class="form_input required" >
							</div>
  ...
  <div class="logo">
											...
											<div class="front-face"><a href="anasayfa">&nbsp;&nbsp;&nbsp;&nbsp;<img src="img/<?=$ayar['foto'];?>" width="330" height="160"></a></div>
