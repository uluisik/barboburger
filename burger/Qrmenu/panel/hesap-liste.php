               ...
               <div id="main-wrapper">
                  ...
                  <div class="pageheader pd-t-25 pd-b-35">
                     ...
                     <div class="breadcrumb pd-0 mg-0">
                        ...
                        <a class="breadcrumb-item" href="">Hesap Talepleri</a>
...
<!-- Hoverable Table Start -->
            ...
            $sorgu = $dbh->prepare("SELECT * FROM hesap_iste");
            ...
            while ($sonuc = $sorgu->fetch()) {
                ...
                ?>
                                    ...
                                    <tr>
                                       ...
                                       <td><?=$sonuc['telefon'];?></td>
                                       <td>
                                          <td><a href="hesap-sil.php?id=<?=$sonuc['id'];?>" class="btn btn-primary"> Sil</a> </td>  
                                       </td>
