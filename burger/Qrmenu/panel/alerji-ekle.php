<?php $blok="alerji-yonetim"; $sayfa="alerji-ekle"; ?>
            ...
            if ($baslik <> "" && $aciklama <> "" && isset($_FILES['foto'])) 
                ...
                if ($boyut > (1024 * 1024 * 10)) {
                    ...
                    echo '';
                                ...
                                $sql = "INSERT INTO alerji SET foto=:foto, baslik=:baslik, aciklama=:aciklama;";
                                ...
                                if ($durum) {
                                    ...
                                    foreach ($_POST["en"] as $key => $value) {
                                       dilguncelle("en","alerji",$sonId,$key,$value);
                                    }

                                    foreach ($_POST["ar"] as $key => $value) {
                                       dilguncelle("ar","alerji",$sonId,$key,$value);
                                    }

                                    foreach ($_POST["ru"] as $key => $value) {
                                       dilguncelle("ru","alerji",$sonId,$key,$value);
                                    }
               ...
               <div id="main-wrapper">
                  ...
                  <div class="pageheader pd-t-25 pd-b-35">
                     ...
                     <div class="breadcrumb pd-0 mg-0">
                        ...
                        <a class="breadcrumb-item" href="">Yeni Alerji Ekle</a>
                                 ...
                                 <!-- resim boyut değeri -->
                                             ...
                                             <div class="col-lg-12">
                                                   <div class="form-group">
                                                      <label class="form-control-label active">Alerji Başlık : <span class="tx-danger">*</span></label>
                                                ...
                                                <div class="col-lg-12">
                                                   <div class="form-group">
                                                      <label class="form-control-label active">Alerji Açıklaması : <span class="tx-danger">*</span></label>
                                    ...
                                    <div class="tab-pane fade" id="navs-en">
                                       ...
                                       <div class="col-lg-12"> 
                                                 ...
                                                 <div class="col-lg-12"> 
                                                   <div class="form-group">
                                                      <label class="form-control-label active">Alerji Açıklama : <span class="tx-danger">*</span></label>
