...
<?php
 ...
 if ($boyut > (1024 * 1024 * 30)) {
  ...
  $settings = $dbh->prepare("UPDATE menu_kategori SET foto = '".$foto_url."' WHERE id = '".$id."'");
  ...
  $update = $dbh->prepare("UPDATE menu_kategori SET baslik = '".$baslik."',aciklama = '".$aciklama."' WHERE id = '".$id."'");

    $update->execute();

    foreach ($_POST["en"] as $key => $value) {
         dilguncelle("en","menu_kategori",$id,$key,$value);
      }

      foreach ($_POST["ar"] as $key => $value) {
         dilguncelle("ar","menu_kategori",$id,$key,$value);
      }

      foreach ($_POST["ru"] as $key => $value) {
         dilguncelle("ru","menu_kategori",$id,$key,$value);
      }
...
$sonuc = $sorgu->fetch();
$sonucen = cevir("menu_kategori",$sonuc,"en"); 
$sonucru = cevir("menu_kategori",$sonuc,"ru"); 
$sonucar = cevir("menu_kategori",$sonuc,"ar"); 
                           ...
                           <div class="card-body collapse show" id="collapse8">
                              ...
                              <div class="error-notice"> 
                                 ...
                                 <div class="oaerror success">
                                    ...
                                    <strong>BİLGİLENDİRME..</strong> - Logonun Kalitesi İçin Önerilen Boyutlar: <b>500x500</b> px'dir.
